...
class AppStyles {
  ...
  //
  static TextStyle medium({double size = 16, Color color = Colors.black, FontWeight weight = FontWeight.normal }) {
    return TextStyle(
        color: color,
        fontSize: size,
  ...
  //
  static TextStyle bold({double size = 16, Color color = Colors.black, FontWeight weight = FontWeight.normal }) {
    return TextStyle(
        color: color,
        fontSize: size,
        fontWeight: FontWeight.bold
  ...
  //
  static TextStyle semibold({double size = 18, Color color = Colors.black }) {
    return TextStyle(
        color: color,
        fontSize: size,
        fontWeight: FontWeight.w600
